...
4. In `unicast_probing.py`, change the `<COLLECTOR_SERVER_IP>` to the IP address of
   your collector server. Ensure that the server has ports 7400, 7410, 7411, and 7412 open
   so that it can receive the responses.

5. Run `./run_scanner.sh` to initiate the scanning process.
