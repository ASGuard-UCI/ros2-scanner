...
COLLECTOR_IP = os.getenv("COLLECTOR_SERVER_IP", "<COLLECTOR_SERVER_IP>")
...
def main():
    """
    Iterate over a random permutation of the IPs in the IPv4 space and send
